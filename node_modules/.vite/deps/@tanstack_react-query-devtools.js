  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) {
        ...
        Devtools = lazy(() => import("./OHEVZFKG-WP3SAK5D.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component2)) {
        ...
        Devtools = lazy(() => import("./ZXCTK5ZC-R7WH6TEL.js"));
...
function ReactQueryDevtoolsPanel(props) {
  ...
  React2.useEffect(() => {
    var _a3;
    devtools.setOnClose((_a3 = props.onClose) != null ? _a3 : () => {
    });
