    ...
    React21.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = (event) => {
          var _a, _b, _c, _d;
          pointerMoveDelta = {
            x: Math.abs(Math.round(event.pageX) - ((_b = (_a = triggerPointerDownPosRef.current) == null ? void 0 : _a.x) != null ? _b : 0)),
...
var SelectItem = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textValue, setTextValue] = React21.useState(textValueProp != null ? textValueProp : "");
